...
export const pricingFeesDocumentationPage: DocumentationPage = {
  ...
  blocks: [
    ...
    },
    {
      ...
      paragraphs: [
        'Starter Tier: 10% of order subtotal with tiered caps',
        '• Up to £50: Capped at £3.50',
        '• £50-£100: Capped at £5.50',
        '• £100+: Capped at £8.00',
        'Professional: 8% of order subtotal',
        'Business: 6% of order subtotal',
        '',
        'Example (£25 order on Starter tier):',
        '• Order subtotal: £25.00',
        '• Platform fee (10%): £2.50',
        '• Customer pays: £27.50',
        '• Merchant receives: £25.00',
        '',
        'Example (£50 order on Starter tier - first tier cap):',
        '• Order subtotal: £50.00',
        '• Platform fee (10% = £5.00, capped at £3.50): £3.50',
        '• Customer pays: £53.50',
        '• Merchant receives: £50.00',
        '',
        'Example (£75 order on Starter tier - second tier cap):',
        '• Order subtotal: £75.00',
        '• Platform fee (10% = £7.50, capped at £5.50): £5.50',
        '• Customer pays: £80.50',
        '• Merchant receives: £75.00',
        '',
        'Small Order Protection: Orders under £10 may have an additional small order fee to ensure the platform covers payment processing costs (Stripe charges 2.9% + £0.30 on all transactions). On large orders where Stripe fees exceed the cap, a safety floor ensures we always cover processing costs.',
      ],
    },
    {
      type: 'section',
