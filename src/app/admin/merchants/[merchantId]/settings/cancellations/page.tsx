...
export default function AdminMerchantCancellationsPage() {
    ...
    <ProtectedRoute requireRole={['admin']}>
      <div className={styles.cancellations}>
        <div className={styles.cancellations__header}>
          <Link href={`/admin/merchants/${merchantId}/settings`} className={styles.cancellations__backLink}>
            ← Back to {merchant?.business_name || 'Merchant'} Settings
          </Link>
          <div className={styles.cancellations__adminBadge}>
            <span className={styles.cancellations__badge}>🔧 ADMIN MODE</span>
            <Typography variant="body-small" style={{ color: 'var(--color-text-secondary)' }}>
              Managing cancellation policy for {merchant?.business_name || 'merchant'}
            </Typography>
          </div>
