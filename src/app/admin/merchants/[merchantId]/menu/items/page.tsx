      ...
      <div className={styles.items}>
        <div className={styles.items__header}>
          <div className={styles.items__headerContent}>
            <Link href={`/admin/merchants/${merchantId}`} className={styles.items__backLink}>
              ← Back to {merchant?.business_name || 'Merchant'} Dashboard
            </Link>
            <div className={styles.items__adminBadge}>
              <span className={styles.items__badge}>🔧 ADMIN MODE</span>
              <Typography variant="body-small" style={{ color: 'var(--color-text-secondary)' }}>
                Managing menu items for {merchant?.business_name || 'merchant'}
              </Typography>
            </div>
            ...
            <Typography variant="body-medium" style={{ color: 'var(--color-text-secondary)' }}>
              Manage menu items and their availability for this merchant
            </Typography>
          </div>
          <Button
            variant="primary"
